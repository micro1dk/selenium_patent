...
class PATENT_PAGE(Browser, PyautoGUI):
  ...
  def login_patent(self):
    try:
      ...
      pyautogui.press(['tab', 'tab']); time.sleep(0.3)
      pyautogui.write('akzmdlsvh2015!!'); time.sleep(0.3)
      pyautogui.press(['enter']); time.sleep(1.3)
  ...
  def script_patent(self, today_dir, markinfo_acc_no):
    txt_file = open(f'{today_dir}\\info.txt')
